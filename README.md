...
|:---------------|:---------------------------------------------------|:-------------------|
| `version`      | The version of the [`buf` CLI][buf-cli] to install | [`v1.16.0`][version] |
...
[version]: https://github.com/bufbuild/buf/releases/tag/v1.16.0

...
|:---------------|:---------------------------------------------------|:-------------------|
| `version`      | The version of the [`buf` CLI][buf-cli] to install | [`v1.25.1`][version] |
...
steps:
  - uses: actions/checkout@v2
  # Installs version 1.25.1
  - uses: bufbuild/buf-setup-action@v1.25.1
    with:
      version: 1.25.1
  # Should output 1.25.1
  - run: buf --version
```
...
[version]: https://github.com/bufbuild/buf/releases/tag/v1.25.1

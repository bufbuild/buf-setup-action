...
|:---------------|:---------------------------------------------------|:-------------------|
| `version`      | The version of the [`buf` CLI][buf-cli] to install | [`v1.32.0`][version] |
...
steps:
  - uses: actions/checkout@v2
  # Installs version 1.32.0
  - uses: bufbuild/buf-setup-action@v1.32.0
    with:
      version: 1.32.0
  # Should output 1.32.0
  - run: buf --version
```
...
[version]: https://github.com/bufbuild/buf/releases/tag/v1.32.0

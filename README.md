...
|:---------------|:---------------------------------------------------|:-------------------|
| `version`      | The version of the [`buf` CLI][buf-cli] to install | [`v1.13.1`][version] |
...
[version]: https://github.com/bufbuild/buf/releases/tag/v1.13.1

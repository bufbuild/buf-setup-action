...
steps:
  ...
  # Install the `buf` CLI
  - uses: bufbuild/buf-setup-action@vfoobar
...
|:---------------|:---------------------------------------------------|:-------------------|
| `version`      | The version of the [`buf` CLI][buf-cli] to install | [`vfoobar`][version] |
...
[version]: https://github.com/bufbuild/buf/releases/tag/vfoobar
